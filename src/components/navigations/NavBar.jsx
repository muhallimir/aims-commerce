...
import { Box, Typography, Switch, Button, IconButton, Drawer } from "@mui/material";
...
function Header() {
    ...
    return (
        ...
        >
            ...
            >
                <Image alt="main-logo" src={darkMode ? mainDarkLogo : mainLogo} width={100} height={40} priority />
            </Box>
            ...
            <Box sx={{ display: "flex", alignItems: "center" }}>
                ...
                <Switch
                    ...
                    color="primary"
                />
                <IconButton onClick={toggleDrawer} sx={{ display: { xs: 'flex', sm: 'none' } }}>
                    <MenuIcon sx={{ color: darkMode ? "common.white" : "common.black" }} />
                </IconButton>
            </Box>
