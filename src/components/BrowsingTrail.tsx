...
/**
 * Browsing trail: the shopper's recently-viewed products from this
 * browser, with per-item remove and clear-all. Product pages record
 * views; this strip reads them back.
 */
export function BrowsingTrail() {
