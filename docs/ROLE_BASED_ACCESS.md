...
> Test runners: `npm run test:e2e`, `npm run test:browser`, `npm run test:scan` (in `aims-commerce/`).
> Source of truth: `aims-commerce/scripts/test/e2e_test.mjs` (API) and
> `aims-commerce/scripts/test/browser_e2e_start_selling.mjs` (browser).
